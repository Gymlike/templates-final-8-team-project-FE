...
function signUp() {
	...
	if (localStorage.getItem('verifyEmailCode') == 1) {
		var settings = {
			"url": "http://ec2-43-200-226-255.ap-northeast-2.compute.amazonaws.com/api/user/signup",
			"method": "POST",
			"timeout": 0,
			"headers": {
...
function logout() {
	var settings = {
		"url": "http://ec2-43-200-226-255.ap-northeast-2.compute.amazonaws.com/api/user/logout",
		"method": "DELETE",
		"timeout": 0,
		"headers": {
